...
<div class="page-header">
    <nav class="breadcrumb">
        <a href="/plans">Individual rejalar</a>
        <span>›</span>
        <span><?= $isEdit ? 'Tahrirlash' : 'Yangi' ?></span>
    </nav>
        ...
        <div class="form-group">
            ...
            <select id="student_id" name="student_id" required>
                ...
                <?php foreach ($students as $s): ?>
                    <option value="<?= e($s['id']) ?>"
                        <?= (string) ($plan['student_id'] ?? '') === (string) $s['id'] ? 'selected' : '' ?>>
                        <?= e($s['full_name']) ?>
                    </option>
                <?php endforeach; ?>
            </select>
        ...
        <div class="form-group">
            ...
            <select id="supervisor_id" name="supervisor_id">
                ...
                <?php foreach ($supervisors as $su): ?>
                    <option value="<?= e($su['id']) ?>"
                        <?= (string) ($plan['supervisor_id'] ?? '') === (string) $su['id'] ? 'selected' : '' ?>>
                        <?= e($su['full_name']) ?>
                    </option>
                <?php endforeach; ?>
            </select>
        ...
        <div class="form-group">
            ...
            <select id="status" name="status">
                <?php foreach ($statuses as $val => $label): ?>
                    <option value="<?= e($val) ?>"
                        <?= ($plan['status'] ?? 'draft') === $val ? 'selected' : '' ?>>
                        <?= e($label) ?>
                    </option>
                <?php endforeach; ?>
            </select>
